...
#aside from different list generation method, the rest is similar
import random 
a = random.sample(range(100),random.randint(10,30))
b = random.sample(range(100),random.randint(10,30))
print(f"a={a}")
print(f"b={b}")
